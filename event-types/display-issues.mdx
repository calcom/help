---
title: "Link slot display issues"
---
...
<Steps>
  ...
  <Step title="Check Slot optimization">
    - Refer to our [Slot optimization](https://cal.com/help/event-types/optimized-slots#why-use-optimized-slots) article to find out more. 
