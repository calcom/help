...
<Info>
  The event type specific checking for conflicts is only for your **native calendar events. **Cal.com events/booked slots are making you busy for the same slot across **all of your individual events, **regardless of the calendar you are adding this event to**. **That time is busy on your [upcoming bookings page](https://app.cal.com/bookings/upcoming). 
</Info>