...
**Fixed Hosts** are individuals who are consistently present at every meeting. To select a Fixed Host, first ensure they are not also listed as a Round Robin host. 
