...
| `WEBHOOK_READ` | View webhooks | Listing and viewing webhook subscriptions |
| `WEBHOOK_WRITE` | Create, edit, and delete webhooks | Creating, updating, and deleting webhook subscriptions |
...
| `TEAM_ROUTING_FORM_WRITE` | Create, edit, and delete team routing forms |
...
| `ORG_MEMBERSHIP_READ` | View organization memberships |
| `ORG_MEMBERSHIP_WRITE` | Create, edit, and delete organization memberships |
| `ORG_ROUTING_FORM_READ` | View organization routing forms |
| `ORG_ROUTING_FORM_WRITE` | Create, edit, and delete organization routing forms |
