...
- When routing to an account:
  ...
  - Routing can be based on the account ownership or a [custom user lookup field](/apps-and-integrations/salesforce#route-to-custom-lookup-field) on the account (or on a connected object via dot-notation).
