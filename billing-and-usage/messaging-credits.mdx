...
Cal.ai pricing is based on credits, with each call consuming a set number of credits based on its length and complexity. The cost is 29 credits per minute, which equals $0.29 per minute.
