...
2. Create or edit an event (e.g., "1:1 Coaching Session")
3. Customize:
...
- Email confirmations
- Reminders (Please check with your admin if they have already set up reminder workflows. In any case, you can create new workflows for your event types)
