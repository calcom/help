...
## What is [Cal.ai](http://Cal.ai)?

[Cal.ai](http://Cal.ai) is an AI-powered scheduling assistant that automates the management of your meetings. It integrates directly with [**Cal.com**](http://Cal.com)** workflows**, allowing you to book, reschedule, cancel, confirm, and follow up on meetings seamlessly. Through phone calls, [Cal.ai](http://Cal.ai) communicates with participants on your behalf, ensuring your schedule is always up to date, even when you’re unavailable. It works 24/7, handling scheduling tasks automatically without requiring manual intervention.

## How does [Cal.ai](http://Cal.ai) work and what are the use cases?

[Cal.ai](http://Cal.ai) is fully integrated into [Cal.com](http://Cal.com) workflows. Once configured, it can automatically:
...
Since [Cal.ai](http://Cal.ai) operates within [Cal.com](http://Cal.com) workflows, any actions taken by the assistant, such as making calls or sending messages, are directly tied to your account's calendar and settings. This ensures seamless synchronization between your meetings and [Cal.ai](http://Cal.ai)'s scheduling tasks.

## Set up a [Cal.ai](http://Cal.ai) workflow

Setting up a [Cal.ai](http://Cal.ai) workflow is simple:
...
4. Add the action: ‘Call attendee using [Cal.ai](http://Cal.ai) Voice Agent’.
...
7. Test the [Cal.ai](http://Cal.ai) Agent\! You can test the [Cal.ai](http://Cal.ai) Agent by calling the phone number or by using the ‘Test Web Call’ functionality. Please be aware that both web calls and phone number calls consume credits.
...
## Add a phone number to your [Cal.ai](http://Cal.ai) workflow

You can easily add a phone number by buying a phone number or by importing a phone number. At first, follow the previous steps on how to set up a [Cal.ai](http://Cal.ai) workflow. When clicking on ‘Connect Phone Number’ follow the following steps:

### Buying a phone number

You can buy a phone number from [Cal.com](http://Cal.com) by following the below steps:
...
Prompts define the messages [Cal.ai](http://Cal.ai) uses when interacting with meeting participants. Prompts also make sure how your agent interpret situations and which steps it should follow. There’s a default prompt in every single workflow, however you can edit the prompt to your liking. To edit a prompt follow the steps on how to set up a [Cal.ai](http://Cal.ai) workflow. Then follow the additional steps:
...
4. Add variables to your prompt: Variables allow you to create personalized messages that [Cal.ai](http://Cal.ai) uses during phone calls, ensuring that each interaction is tailored to your needs. Learn more about the available variables here: https://cal.com/help/workflows/workflowsoverview#dynamic-text-variables
5. Click on ‘Save’ and you’re done editing your prompt.

## Costs and plan limitations of [Cal.ai](http://Cal.ai)

[Cal.ai](http://Cal.ai) operates on a credit system, which is tied to the workflow credits used across the entire platform, including SMS and WhatsApp workflows. The credits allocated to your account are shared across these different communication channels.\
...
Please note that the credits you receive are used for both [Cal.ai](http://Cal.ai)’s phone call-based scheduling actions and for any SMS/WhatsApp workflows you create. This means that when using [Cal.ai](http://Cal.ai) to make phone calls, those credits are consumed along with credits used for sending SMS or WhatsApp messages in workflows.\
