...
Cal.ai pricing is based on the number of credits you use. Each call consumes a set number of credits depending on its length and complexity. The charge per minute is 29 credits, equalling $0.29 per minute. For more information, please take a look at our [credit system](https://cal.com/help/billing-and-usage/messaging-credits.mdx)
