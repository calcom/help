...
<Note>
  {" "}
  The snippets provided are automatically updated as per the cal.com instance. **So,
  even when self hosting, you can simply copy and paste the snippets from there{" "}
</Note>
.
...
<img
  src="/images/i1600x900-APQPQxcN1aZt_m0casf.png"
  alt="Embed options overview"
/>
...
<Frame>
  <img
    src="/images/i1600x900-RDSMehJ8vTwZ_zcals5.png"
    alt="Inline embed example"
  />
</Frame>
...
<Frame>
  <img
    src="/images/i1600x900-IQ6S7Rq9d94T_d5vl8m.png"
    alt="Pop-up embed example"
  />
</Frame>
...
<Frame>
  <img
    src="/images/i1600x900-PNSh9u2m_QV2_v80gvk.png"
    alt="Floating button embed example"
  />
</Frame>
...
<Frame>
  <img
    src="/images/i1600x900-iihnWwzsuARg_llvldw.png"
    alt="Routing form embed example"
  />
</Frame>
